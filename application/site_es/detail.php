...
<!--                                 <div class='col-xs-4 rt' >Banco</div><div class='col-xs-8'><span id='status'>Santander</span></div>
                            ...
                            <div class='col-xs-12 table-responsive'>
                                ...
                                <table class="table">                        
                                    ...
                                    <tr>                                        
                                        ...
                                        <td class='right rt' colspan='4'>+Envio</td>

                                        <td><span id='shipping'> $<?=number_format(($value->total_amount), 2, '.', ',')?> MXN</span></td>
                                    ...
                                    <tr>
                                        ...
                                        <td class='right rt' colspan='4'>Total</td>
                                ...
                                <p>	* Envíos a Ciudad de México de 1-3 días.<br>
 ...
 -->
                            ...
                            <!--boton de  OpenPay INICIO -->

<!--                             <div class='col-xs-6 bx_formulario'>
                                <a href="<?=site_url('home/openpay_send_charge?order='.$_GET['order'])?>" class="btn btn-info bt op-">Pagar con Openpay</a>
                            </div> -->

                            <!--boton de  OpenPay FIN -->
...
<style type="text/css">
    ...
    @media print {
        ...
        tbody td{ font-size: 1em !important; padding: 0 !important;  }

        #payimg,#pay,.localizacion_pag,.breadcrumbs,.header,.footer.paypal_btn,h2,button,footer, #btn_float, .bt-devolver, td strong, .no-print{ display: none !important;}
